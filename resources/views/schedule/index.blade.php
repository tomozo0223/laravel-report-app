        ...
        <table class="w-full m-auto border border-gray-600 bg-white">
            ...
            <tbody>
                @forelse ($schedules as $index => $schedule)
                    <tr
                        class="text-sm md:text-base hover:bg-gray-100 cursor-pointer {{ $index % 2 === 1 ? 'bg-green-100' : '' }}"onclick="location.href='{{ route('schedule.show', ['schedule' => $schedule->schedule_id]) }}'">
